-- BUSCAR TESTAMENTOS
SELECT * FROM `view_testamentos`
WHERE `testamentos_abreviado` = :testamentos_abreviado;

-- BUSCAR AUTORES
SELECT * FROM `view_autores`
