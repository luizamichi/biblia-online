...
CREATE TABLE `testamentos` (
	`testamento_id` TINYINT(2) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'TABELA DE TESTAMENTOS', -- INT/PK (CHAVE)
...
CREATE TABLE `livros` (
	...
	`livro_testamento_id` TINYINT(2) UNSIGNED NOT NULL COMMENT 'FK DA TABELA DE TESTAMENTOS', -- INT/FK (CHAVE TESTAMENTO)
...
-- TABELA VERSÍCULOS (404.351)
DROP TABLE IF EXISTS `versiculos`;
SET CHARACTER_SET_CLIENT=utf8mb4;
CREATE TABLE `versiculos` (
	`versiculo_id` INT(8) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'TABELA DE VERSÍCULOS', -- INT/PK (CHAVE)
