...
<div class="container grid ui">
	...
	<form action="api" class="attached fluid form segment ui" id="formulario-post" method="post">
		...
		<div class="fields two">
			<div class="field">
				...
				<input id="posicao" max="40" min="0" name="posicao" placeholder="Posição" required="required" type="number" value="<?= $livro->posicao ?>"/>
			</div>
			<div class="field">
				<label for="capitulos">Capítulos</label>
				<input id="capitulos" max="150" min="0" name="capitulos" placeholder="Capítulos" required="required" type="number" value="<?= $livro->capitulos ?>"/>
			</div>
		</div>
		<div class="field">
